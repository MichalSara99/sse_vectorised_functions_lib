...
bool sse_basics::abs_sse(double const *in_aligned_16, int size, double *out_aligned_16)
{
    return sse_math::abs_sse_packed(in_aligned_16, size, out_aligned_16);
}

bool sse_basics::abs_sse(float const *in_aligned_16, int size, float *out_aligned_16)
{
    return sse_math::abs_sse_packed(in_aligned_16, size, out_aligned_16);
}

bool sse_basics::sqrt_sse(double const *in_aligned_16, int size, double *out_aligned_16)
{
    return sse_math::sqrt_sse_packed(in_aligned_16, size, out_aligned_16);
}

bool sse_basics::sqrt_sse(float const *in_aligned_16, int size, float *out_aligned_16)
{
    return sse_math::sqrt_sse_packed(in_aligned_16, size, out_aligned_16);
}

bool sse_basics::sqrpow_sse(double const *in_aligned_16, int size, double *out_aligned_16)
{
    return sse_math::sqrpow_sse_packed(in_aligned_16, size, out_aligned_16);
}

bool sse_basics::sqrpow_sse(float const *in_aligned_16, int size, float *out_aligned_16)
{
    return sse_math::sqrpow_sse_packed(in_aligned_16, size, out_aligned_16);
}
...
bool sse_basics::exp_fast_sse(double const *in_aligned_16, int size, double *out_aligned_16)
{
    return sse_math::exp_fast_sse_packed(in_aligned_16, size, out_aligned_16);
}

bool sse_basics::exp_fast_sse(float const *in_aligned_16, int size, float *out_aligned_16)
{
    return sse_math::exp_fast_sse_packed(in_aligned_16, size, out_aligned_16);
}

bool sse_basics::exp_sse(double const *in_aligned_16, int size, double *out_aligned_16)
{
    return sse_math::exp_sse_packed(in_aligned_16, size, out_aligned_16);
}

bool sse_basics::exp_sse(float const *in_aligned_16, int size, float *out_aligned_16)
{
    return sse_math::exp_sse_packed(in_aligned_16, size, out_aligned_16);
}
...
bool sse_basics::log_sse(float const *in_aligned_16, int size, float *out_aligned_16)
{
    return sse_math::log_sse_packed(in_aligned_16, size, out_aligned_16);
}

bool sse_basics::log_sse(double const *in_aligned_16, int size, double *out_aligned_16)
{
    return sse_math::log_sse_packed(in_aligned_16, size, out_aligned_16);
}
...
bool sse_normal_distribution::norm_cdf_sse(float const *in_aligned_16, int size, float *out_aligned_16)
{
    return sse_math::norm_cdf_sse_packed(in_aligned_16, size, out_aligned_16);
}

bool sse_normal_distribution::norm_cdf_sse(double const *in_aligned_16, int size, double *out_aligned_16)
{
    return sse_math::norm_cdf_sse_packed(in_aligned_16, size, out_aligned_16);
}

bool sse_normal_distribution::norm_pdf_sse(float const *in_aligned_16, int size, float *out_aligned_16)
{
    return sse_math::norm_pdf_sse_packed(in_aligned_16, size, out_aligned_16);
}

bool sse_normal_distribution::norm_pdf_sse(double const *in_aligned_16, int size, double *out_aligned_16)
{
    return sse_math::norm_pdf_sse_packed(in_aligned_16, size, out_aligned_16);
}

bool sse_normal_distribution::norm_inv_cdf_sse(float const *in_aligned_16, int size, float *out_aligned_16)
{
...
bool sse_specials::erf_sse(double const *in_aligned_16, int size, double *out_aligned_16)
{
    return sse_math::erf_sse_packed(in_aligned_16, size, out_aligned_16);
}

bool sse_specials::erf_sse(float const *in_aligned_16, int size, float *out_aligned_16)
{
    return sse_math::erf_sse_packed(in_aligned_16, size, out_aligned_16);
}

bool sse_specials::erfc_sse(double const *in_aligned_16, int size, double *out_aligned_16)
{
    return sse_math::erfc_sse_packed(in_aligned_16, size, out_aligned_16);
}

bool sse_specials::erfc_sse(float const *in_aligned_16, int size, float *out_aligned_16)
{
    return sse_math::erfc_sse_packed(in_aligned_16, size, out_aligned_16);
}
