...
template<>
SSE_MATH_X86_API float* sse_utility::aligned_alloc<float>(std::size_t size, std::size_t alignment) {
	return sse_utilities::aligned_alloc<float>(size, alignment);
}
// aligned allocation for double-precision floating point
template<>
SSE_MATH_X86_API double* sse_utility::aligned_alloc<double>(std::size_t size, std::size_t alignment) {
