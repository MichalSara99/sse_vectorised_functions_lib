include asm_x86_incs/normal_dist_functions.inc

.code
;;		extern "C" bool norm_pdf_sse_pd(double const* x, int n, double* out);
norm_pdf_sse_pd					proc uses ebx,
										x_ptr:ptr real8,
										n_arg:dword,
										out_ptr:ptr real8
...
norm_inv_cdf_sse_ps				proc uses ebx,
										x_ptr:ptr real4,
										n_arg:dword,
										out_ptr:ptr real4	
...
norm_inv_cdf_sse_pd				proc uses ebx,
										x_ptr:ptr real8,
										n_arg:dword,
										out_ptr:ptr real8
